...
export const getRandomArticle = async (
  ...
  try {
    ...
    while (attemptCount < maxAttempts) {
      ...
      const randomResponse = await axios.get<WikipediaResponse>(
        WIKIPEDIA_API_URL,
        {
          params: {
            action: 'query',
      ...
      const contentResponse = await axios.get<WikipediaResponse>(
        WIKIPEDIA_API_URL,
        {
          params: {
            action: 'query',
...
export const getRandomArticles = async (
  ...
  try {
    ...
    // If we didn't get enough articles, try to fetch more
